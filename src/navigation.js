...
export const headerData = {
  ...
  actions: [
    { text: 'Regístrate', href: 'https://playbusiness.mx/pre-registro?utm_campaign=segundo-sueldo&utm_medium=organic&utm_source=2s_domain&utm_content=landing&utm_term=', target: '_blank', variant: Variant.Secondary },
    { text: 'Inicia sesión', href: 'https://playbusiness.mx/entrar?utm_campaign=segundo-sueldo&utm_medium=organic&utm_source=2s_domain&utm_content=landing&utm_term=', target: '_blank', variant: Variant.Link }],
};
